...
type stubAgentSessionService struct {
	acquireTuttiModeActivationSessionLockFn func(context.Context, string, string) (func(), error)
...
func (s stubAgentSessionService) AcquireTuttiModeActivationSessionLock(ctx context.Context, workspaceID, agentSessionID string) (func(), error) {
	if s.acquireTuttiModeActivationSessionLockFn == nil {
		return func() {}, nil
	}
	return s.acquireTuttiModeActivationSessionLockFn(ctx, workspaceID, agentSessionID)
}
